...
# Elegy% NMG [Dashmaster Reroute] for 1.2.2.1 and 1.4.3.2+
...
- Isma’s Tear: Picking up Isma’s is optional, but it’s a bit slower by approx. 10 seconds
...
## Ancestral Mound
-   Grab soul catcher (early control if on LP)
...
## Main Menu with Dashmaster

-   Bench at leg eater
-   Regular fungal movement, do epogo (hp should be comfy so damageful is fine)
-   Early control claw if on 1221
-   Collect dashmaster

## Enter Sanctum
- Equip dashmaster
- Skip the ogres notch, go to city gate
- Head up to sanctum

- Patch differences:
    - 1221 – Lever skip to Sanctum
    - LP – While going around, kill the heavy sentry and husk sentry for ~20 geo
-   Save the grub under sanctum
...
-   Head to Broken Vessel, do not buy the bench
-   Collect broken vessel key
-   Get Monarch Wings
...
## Waterways
- (Optionally) Unequip dashmaster, loses nothing in menuing and 0.8s in movement, but makes for an easier spike tunnel on 1221
- Hit KS bell
...
-   Swap dashmaster for soul catcher
